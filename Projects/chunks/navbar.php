<section class="fnavbar">
	<div class="navbar-fixed">
		<nav>
			<div class="nav-wrapper">
				<a href="#" class="brand-logo">The Restaurent</a>
				<a href="#" data-target="mobile-demo" class="sidenav-trigger"><i class="material-icons">menu</i></a>
				<ul class="right hide-on-med-and-down">
					<li><a href="/The Restaurent" class="hvr-grow">Home</a></li>
					<li><a href="/The Restaurent/about-restro-girls.php" class="hvr-grow">About Us</a></li>
	...
	<ul class="sidenav" id="mobile-demo">
		<li><a href="/The Restaurent">Home</a></li>
		<li><a href="/The Restaurent/about-restro-girls.php">About Us</a></li>
