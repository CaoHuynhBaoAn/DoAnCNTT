	...
	<div class="row" style="padding-left: 50px; padding-right: 50px;">
		...
		<div class="col s12 m12 l4" style="padding: 50px 5px;">
			<div class="card">
				...
				<div class="card-content">
					<span class="card-title activator grey-text text-darken-4">Viet Nam<i class="material-icons right">more_vert</i></span>
					<div class="card-content">
						<p>Wanna check out the Mouth-Watering Foods of this category ? Explore Now!</p>
					</div>
				</div>
				<div class="card-reveal">
					<span class="card-title grey-text text-darken-4">Viet Nam<i class="material-icons right">close</i></span>
					<p>Viet Nam cuisine is an important part of Viet Nam culture, which includes cuisine originating from the diverse regions of Viet Nam.</p>
				</div>
			</div>
		</div>
		<div class="col s12 m12 l4" style="padding: 50px 5px;">
